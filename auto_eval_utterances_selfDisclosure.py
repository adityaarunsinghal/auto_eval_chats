...
if __name__=="__main__":
    ...
    evals = evaluate_utterances(response_posts, "pairwise_selfDisclosure_scores")
    evals.to_csv("/scratch/as11919/empathic-conversations-chatbot/data/turn_lvl_scores_data/cleaned_pairwise_self_disclosure_scores.csv")
